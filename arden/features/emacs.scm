(define-module (arden features emacs)
  ...
  (define (get-home-services config)
    (list
     (simple-service
      ...
      `(("EDITOR" . ,(file-append %arden-emacs-package "/bin/emacs"))
...
(define %arden-emacs-package emacs-next-pgtk-latest)

(define %arden-emacs-base-features
  (list
   (feature-emacs-default-editor)
   (feature-emacs
    #:emacs %arden-emacs-package
